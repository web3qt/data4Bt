...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("binance.market_type", "spot")
	v.SetDefault("binance.exchange_info_url", "")
...
func validateConfig(config *Config) error {
	...
	switch config.Binance.MarketType {
	case "", "spot", "futures_um", "futures_cm":
	default:
		return fmt.Errorf("binance.market_type must be one of: spot, futures_um, futures_cm")
	}
